...
run_cmd "Double_CCA_UPSam_fd_RWKV_MedNeXt Task530 fold 1 验证" \
...
run_cmd "MedNeXt_S_kernel3 Task505 fold 1 验证" \
    mednextv1_train 3d_fullres nnUNetTrainerV2_MedNeXt_S_kernel3 505 1 \
    -p nnUNetPlansv2.1_trgSp_1x1x1 -val
